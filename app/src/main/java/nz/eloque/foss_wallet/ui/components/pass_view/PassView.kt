...
private fun PassPreview() {
    val pass = Pass(
        ...
        it.headerFields = mutableListOf(
            nz.eloque.foss_wallet.model.field.PassField("block", "Block", Content.Plain("S1")),
            nz.eloque.foss_wallet.model.field.PassField("seat", "Seat", Content.Plain("47")),
        )
        it.primaryFields = mutableListOf(
            nz.eloque.foss_wallet.model.field.PassField("name", "Name", Content.Plain("Max Mustermann")),
            nz.eloque.foss_wallet.model.field.PassField("seat", "Seat", Content.Plain("47")),
        )
        it.auxiliaryFields = mutableListOf(
            nz.eloque.foss_wallet.model.field.PassField("block", "Block", Content.Plain("S1 | Gegengerade")),
            nz.eloque.foss_wallet.model.field.PassField("seat", "Seat", Content.Plain("36E")),
        )
        it.secondaryFields = mutableListOf(
            nz.eloque.foss_wallet.model.field.PassField("data1", "data1", Content.Plain("Longer Value here i guess")),
            nz.eloque.foss_wallet.model.field.PassField("data2", "data2", Content.Plain("Shorter Value")),
        )
    }
    PassView(pass, true)
}